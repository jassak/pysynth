...
from pysynth.generators import Oscillator, WhiteNoise, PinkNoise, Wavetable
...
from pysynth.music import Pitch, Note, Scale, Sequencer, Step, StepSequencer, Arpeggiator, PolySequencer
